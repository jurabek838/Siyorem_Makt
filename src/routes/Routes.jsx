...
import Guruhlarthre from "./guruhlarthre/Guruhlarthre"
import Guruhlarfore from "./guruhlarfore/Guruhlarfore";
import Guruhlarfayf from "./guruhlarfayf/Guruhlarfayf"
...
const Routes = ({ setSidebar, sidebar, setDarkmood, darkmood, setValue, language, setLanguage }) => {
  ...
  return (
    <div className="routes">
      ...
      <Route path="/guruhlarthre">
        <Guruhlarthre language={language} setLanguage={setLanguage} setValue={setValue} />
      </Route>
      <Route path="/guruhlarfore">
        <Guruhlarfore language={language} setLanguage={setLanguage} setValue={setValue} />
      </Route>
      <Route path="/guruhlarfayf">
        <Guruhlarfayf language={language} setLanguage={setLanguage} setValue={setValue} />
      </Route>
