...
const Guruhlartwo = ({ language }) => {
  return (
    <div className="wrxmfnnndddedf">



      <div>
        <h2 className='Bugungi'>
          {language === "UZ" ? "Matematika guruhi ro’yhati" : "Add new group"}</h2>
      </div>

      <div className="dfrtyuiuytrf"  >
        <div className="gang_flelter">
          <div className="guruhlar_cards_left">
            <p className="tugri_chiziq">Matematika</p>
        ...
        <div>
          ...
          <table className="trecalof_two" >
            <th ><div className="drtyuiopoiu" ><p>8</p><p>Farrux Sayfiddinov</p> <p>  <label className="checkbox-wrapper"> <input type="checkbox" className="checkbox_element" /> </label> </p> </div></th>

          </table>
          <table className="trecalof_two" >
            <th ><div className="drtyuiopoiu" ><p>9</p><p>Farrux Sayfiddinov</p> <p>  <label className="checkbox-wrapper"> <input type="checkbox" className="checkbox_element" /> </label> </p> </div></th>
